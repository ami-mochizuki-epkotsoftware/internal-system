<div class="form-group row">
    ...
    <div class="col-sm-2">
        <select class="form-control" id="selectDate" name="date" {{ $readOnly ? ' disabled="disabled"' : '' }}>
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <select class="form-control" id="selectWorkStartHour" name="work_start_hour" {{ $readOnly ? ' disabled="disabled"' : '' }}>
    ...
    <div class="col-sm-2">
        <select class="form-control" id="selectWorkStartMinutes" name="work_start_minutes" {{ $readOnly ? ' disabled="disabled"' : '' }}>
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <select class="form-control" id="selectWorkEndHour" name="work_end_hour" {{ $readOnly ? ' disabled="disabled"' : '' }}>
    ...
    <div class="col-sm-2">
        <select class="form-control" id="selectWorkEndMinutes" name="work_end_minutes" {{ $readOnly ? ' disabled="disabled"' : '' }}>
...
<div class="form-group row">
    ...
    <div class="col-sm-2">
        <select class="form-control" id="selectBreakTime" name="break_time" {{ $readOnly ? ' disabled="disabled"' : '' }}>
